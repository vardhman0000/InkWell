    ...
    return (
        <footer className="bg-gray-800 text-white py-8">
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-around">
                ...
                <ul className='flex flex-wrap items-center justify-center gap-x-5 md:justify-end'>
                    
                    <section class="flex justify-center items-center">
                        <a href="https://github.com/vardhman0000" target='blank'>
                            <button
                    ...
                    <section class="flex justify-center items-center">
                        <a href="https://www.linkedin.com/in/vardhman-jain-4a52ba238" target='blank'>
                            <button
                                href="/"
                    ...
                    <section class="flex justify-center items-center">
                        <a href="https://www.instagram.com/vardhman0000/" target='blank'>
                            <button
                                href="/"
                    ...
                    <section class="flex justify-center items-center">
                        <a href="https://discordapp.com/users/Vardhman#4535" target='blank'>
                            <button
                                href="/"
